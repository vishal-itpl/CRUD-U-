    ...
    <div class="container">
        ...
        <form class="form-horizontal" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="password" class="form-control" id="pwd" minlength="8" maxlength="15"  placeholder="Enter password" name="pwd"
                        required>
                </div>
            </div>
            <div class="form-group">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($count > 0) {
            ...
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: 'Email address already exists in the database!',
            });
            </script>";
        }
        else {
